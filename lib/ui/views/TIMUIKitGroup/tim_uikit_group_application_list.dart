...
class TIMUIKitGroupApplicationListState extends TIMUIKitState<TIMUIKitGroupApplicationList> {
  ...
  String _buildUserName(V2TimGroupApplication applicationInfo) {
  ...
  String _buildRequestMessage(V2TimGroupApplication applicationInfo) {
    final option2 = applicationInfo.requestMsg ?? "";
  ...
  Widget _buildEmptyState(TUITheme theme) {
    return Center(
      child: Padding(
        ...
        child: Text(
          ...
          style: TextStyle(
            fontSize: 14,
            color: theme.weakTextColor ?? const Color(0xFF8A8A8A),
          ),
        ),
      ),
    );
      ...
      builder: (context, w) {
        ...
        return ClipRRect(
          ...
          child: Container(
            ...
            child: groupApplicationList.isEmpty
